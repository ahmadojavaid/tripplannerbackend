      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="tripViewsFeatureImage">
            <a href="" class="btn btn-secondary font-weight-normal"> <i class="fa fa-map-marker mr-1"></i> Show map</a>
            <img src="{{$usertrip->tripCountry->countryFile->getFile()}}" alt="">
          ...
          <div class="drag-content mt-0">
            <div class="editor-card mw-100">
              ...
              <p class="more-text mb-2">
                Make your own trip to South Amer Mak Make your own trip to South Amer.cgv Make your own.Make your own trip to S Make your own trip to South Amer.
              </p>
              <button class="btn-secondary btn mb-lg-3 mb-3 d-block" href="#">Edit Trip</button>
            </div>
          </div>
