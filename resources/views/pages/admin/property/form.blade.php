<div class="row">
  <div class="col-md-2 col-sm-12">
    <ul class="nav nav-pills flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link @if(!isset($property)) disabled @endif" id="stacked-pill-images" data-toggle="pill"
          href="#vertical-pill-images" aria-expanded="true">
          Images
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link  @if(!isset($property)) disabled @endif" id="stacked-pill-2" data-toggle="pill"
      ...
      <li class="nav-item">
        <a class="nav-link  @if(!isset($property)) disabled @endif" id="stacked-pill-videos" data-toggle="pill"
