...
<script>
  ...
  let storeUrl = "{{route('admin.property.file.store', 'NaN')}}";
  let updateUrl = "{{route('admin.property.file.upload','NaN')}}";
  let destroyUrl = "{{route('admin.property.file.destroy','NaN')}}";
  storeUrl = storeUrl.replace('NaN' , "{{$property->id}}");
  updateUrl = updateUrl.replace('NaN' , "{{$property->id}}")
  destroyUrl = destroyUrl.replace('NaN' , "{{$property->id}}")
