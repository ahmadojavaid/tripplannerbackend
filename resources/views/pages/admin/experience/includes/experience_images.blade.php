...
<script>
  ...
  let storeUrl = "{{route('admin.experience.file.store', 'NaN')}}";
  let updateUrl = "{{route('admin.experience.file.upload','NaN')}}";
  let destroyUrl = "{{route('admin.experience.file.destroy','NaN')}}";
  storeUrl = storeUrl.replace('NaN' , "{{$experience->id}}");
  updateUrl = updateUrl.replace('NaN' , "{{$experience->id}}")
  destroyUrl = destroyUrl.replace('NaN' , "{{$experience->id}}")
