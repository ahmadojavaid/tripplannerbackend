...
<script>
  ...
  let storeUrl = "{{route('admin.country.place.file.store', 'NaN')}}";
  let updateUrl = "{{route('admin.country.place.file.upload','NaN')}}";
  let destroyUrl = "{{route('admin.country.place.file.destroy','NaN')}}";
  storeUrl = storeUrl.replace('NaN' , "{{$place->id}}");
  updateUrl = updateUrl.replace('NaN' , "{{$place->id}}")
  destroyUrl = destroyUrl.replace('NaN' , "{{$place->id}}")
